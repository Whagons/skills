...
export const optimisticWrites: Record<string, Array<{ table: string; columns?: string[] }>> = {
  "access.assignRole": [{"table":"skill_workspace_members"},{"table":"skill_workspace_invitations"}],
  "access.deleteRole": [{"table":"skill_access_roles"}],
  "access.saveRole": [{"table":"skill_access_roles"}],
  ...
  "team.remove": [{"table":"skill_workspace_members"},{"table":"skill_workspace_invitations"},{"table":"skill_sessions"},{"table":"skill_api_keys"}],
};
